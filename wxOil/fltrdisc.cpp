...
CDiscoverPlugin*		CDiscoverPlugin::m_pSingleInst = NULL;

CDiscoverPlugin::CDiscoverPlugin()
{
	ENSURE( NULL == m_pSingleInst, "Only one instance of CDiscoverPlugin allowed" );
	m_pSingleInst = this;
}
